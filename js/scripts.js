...
/* Post-pageload callback */
function pageLoadCallback() {
	const appInterval = setInterval(() => {
		if ( 'app' in window && 'initSnapScroll' in window.app ) {
			window.app.initSnapScroll();
...
---------------------------------------------------*/
	...
	function PageLoad(postLoadCallback) {
